...
<script lang=\x22ts\x22 setup>\nimport { ref } from \x22vue\x22;\nconst input = ref<string>(\x22\x22);\n</script>`" />
        ...
        <Example title="图标 Icon" id="Id_Input_Icon">
            ...
            <dj-input placeholder="Please Input" v-model="input6">
            ...
            <Table>
                ...
                <template #tbody>
                    ...
                    <Tbody>
                        <td>clear</td>
                        <td>
                            当<dj-badge :text="`clear=\x22true\x22`" />并且点击时触发
                        </td>
                        <td>
                            <dj-badge text="Function() => void" />
                        </td>
            ...
            <Table>
                ...
                <template #tbody>
                    <Tbody>
                        <td>focus</td>
                        <td>输入框获得焦点</td>
                        <td><dj-badge text="Function() => void" /></td>
                    </Tbody>
                    <Tbody>
                        <td>blur</td>
                        <td>输入框失去焦点</td>
